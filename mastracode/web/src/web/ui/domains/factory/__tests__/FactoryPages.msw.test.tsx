...
function useBoardHandlers(options: BoardHandlerOptions = {}): BoardState {
  ...
  server.use(
    ...
    http.post(`${TEST_BASE_URL}/web/factory/projects/${GITHUB_PROJECT_ID}/runs/start`, async ({ request }) => {
    ...
    http.post(
      `${TEST_BASE_URL}/web/factory/projects/${GITHUB_PROJECT_ID}/work-items/:id/transition`,
      async ({ request, params }) => {
...
describe('Factory Board — investigate flow', () => {
  ...
  it('given a server coordinator failure, when a run is requested, then the browser stays on the board and shows the failure', async () => {
    ...
    server.use(
      http.post(`${TEST_BASE_URL}/web/factory/projects/${GITHUB_PROJECT_ID}/runs/start`, () =>
